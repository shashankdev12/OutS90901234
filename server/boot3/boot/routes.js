...
app.post('/exportAllData', function (req, res, cb) 
{
  ...
  {
    //res.download('E:\shashank\old outsmarted\outsmarted\client\storage\questions\csv\')
    //res.download('/shashank/old outsmarted/outsmarted/client/assests/zip/data.zip')
    const file = "/shashank/old outsmarted/outsmarted/client/assests/zip/data.zip";
    //const file = '/home/mayankaggarwal/mysql-test/tutorials_point_img.jpg';
    // Path to store the downloaded file
    const filePath = `/shashank/old outsmarted/outsmarted/client/assests/images`;
